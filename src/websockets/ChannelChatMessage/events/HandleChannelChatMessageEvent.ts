import { deliverShoutoutWithClipToClient } from "../../../modules/ShoutoutWithClip/apis/DeliverShoutoutWithClipToClient.api";
...
export async function handleChannelChatMessageEvent(message: TwitchEventNotification<ChannelChatMessageEvent>) {
    ...
    await deliverShoutoutWithClipToClient(message.payload.event.chatter_user_id)
}